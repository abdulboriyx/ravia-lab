...
export const structureManifest: StructureManifestEntry[] = [
  ...
  {
    role: "eukaryotic-pol-ii-elongation",
    semanticEntityIds: ["rna-polymerase-ii", "rna-polymerase", "nascent-rna", "transcription-bubble"],
    provider: "rcsb-pdb",
    structureId: "5FLM",
    assetUrl: "/spatial-ravia/structures/5FLM.cif",
    format: "mmcif",
    assemblyId: "1",
    title: "Structure of transcribing mammalian RNA polymerase II",
    canonicalSystem: "structure-grounded eukaryotic Pol II elongation V1",
    organism: "Bos taurus (mammalian Pol II)",
    sourceUrl: "https://www.rcsb.org/structure/5FLM",
    selectedChains: ["A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L", "M", "N", "O", "R"],
    chainEntityTypes: {
      A: "protein", B: "protein", C: "protein", D: "protein", E: "protein", F: "protein",
      G: "protein", H: "protein", I: "protein", J: "protein", K: "protein", L: "protein",
      M: "dna", N: "rna", O: "dna", R: "ligand",
    },
    renderMode: "residue-centroid-cloud",
    coarseGrainStride: 2,
    anchors: [
      { id: "upstream-dna", kind: "nucleic-axis", chainId: "M", at: "start", sampleWindow: 2 },
      { id: "downstream-dna", kind: "nucleic-axis", chainId: "O", at: "end", sampleWindow: 2 },
      { id: "rna-exit", kind: "nucleic-axis", chainId: "N", at: "end", sampleWindow: 1 },
      { id: "active-center", kind: "atom-centroid", chainId: "R" },
    ],
    fallback: {
      status: "structure-guided",
      reason: "Do not substitute bacterial RNAP; if 5FLM cannot load, disclose that eukaryotic Pol II geometry is unavailable.",
    },
  },
  {
